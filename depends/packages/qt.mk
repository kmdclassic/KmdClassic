...
$(package)_patches += no_std_exchange_for_cpp11.patch
$(package)_patches += fix-libpng-macos15.patch
...
define $(package)_preprocess_cmds
  ...
  patch -p1 -i $($(package)_patch_dir)/no_std_exchange_for_cpp11.patch && \
  patch -p1 -i $($(package)_patch_dir)/fix-libpng-macos15.patch && \
